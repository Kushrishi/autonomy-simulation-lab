    ...
    return (
        <section className="panel">
            ...
            <p className="panel-note">
                ...
                solves an unweighted nonlinear parametric least-squares problem from
                beacon-style range observations. This is a GNSS-inspired educational model,
                not a full production GNSS receiver.
            </p>
        </section>
    );
}